...
/* ATmegaBOOT.c                                           */
/*                                                        */
/* 20151215: Added guhRF                                  */
/*           by Bernhard Trinnes */
/* 20121003: Added OSD Merkur                             */
/*           by Harald Pichler, Goesta Smekal             */
...
#if defined(__AVR_ATmega128__) || defined(__AVR_ATmega1280__) || defined(__AVR_ATmega128RFA1__) ||  defined ( __AVR_ATmega256RFR2__ )
	if(bootuart == 2) {
...
#if defined(__AVR_ATmega1280__) || defined(__AVR_ATmega128RFA1__) ||  defined ( __AVR_ATmega256RFR2__ )
	/* Enable internal pull-up resistor on pin D0 (RX), in order
	to supress line noise that prevents the bootloader from
	timing out (DAM: 20070509) */
...
*/
	...
	/* This might explain why little endian was used here, big endian used everywhere else.  */
        ...
        address.byte[2] = getch(); //added 3rd byte
		nothing_response();
	}
	...
	/* Write memory, length is big endian and is in bytes  */
		...
		if (getch() == ' ') {
			if (flags.eeprom) {		                //Write to EEPROM one byte at a time
				...
				if (address.byte[2]>127) address_high = 0x01;	//Only possible with m128, m256 will need 3rd address byte. FIXME
				else address_high = 0x00;
#if defined(__AVR_ATmega128__) || defined(__AVR_ATmega1280__) || defined(__AVR_ATmega1281__) || defined(__AVR_ATmega128RFA1__) ||  defined ( __AVR_ATmega256RFR2__ )
				RAMPZ = address_high;
#endif
...
#elif defined( __AVR_ATmega256RFR2__ )
		if (address.word>0xFFFE) flags.rampz = 1;		// for m256
		else flags.rampz = 0;
#endif
		address.word = address.word << 1;	        // address * 2 -> byte location
		if (getch() == 'E') flags.eeprom = 1;
...
#elif  defined __AVR_ATmega256RFR2__
			welcome = "ATmegaBOOT / guhRF - (C) guh GmbH - 180006\n\r";
#endif
...
#if defined(__AVR_ATmega128__) || defined(__AVR_ATmega1280__) || defined(__AVR_ATmega128RFA1__) //ATmega256rfr has no ext memory interface
				/* external bus loop  */
				else if(ch == 'b') {
					putch('b');
					putch('u');
